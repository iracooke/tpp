...
!macro LogDetail txt
push $R0
FileOpen $R0 "$INSTDIR\installer.log" a
FileSeek $R0 0 END
FileWrite $R0 "${txt}"
; write CRLF
FileWriteByte $R0 "13"
...
Function AddToPath
  ...
  !insertmacro LogDetail "checking... PATH=$1";
  ...
  AddToPath_done:
    ReadRegStr $1 ${WriteEnvStr_RegKey} "PATH"
    !insertmacro LogDetail "confirming... PATH=$1";
...
Function RemoveFromPath
  ...
  StrCmp $1 1 RemoveFromPath_NT
    ...
    RemoveFromPath_dosLoop:
      ...
      StrCmp $3 "$0$\r$\n" RemoveFromPath_dosLoopRemoveLine
      StrCmp $3 "$0$\n" RemoveFromPath_dosLoopRemoveLine
      StrCmp $3 "$0" RemoveFromPath_dosLoopRemoveLine
...
Function AddToEnvVar
  ...
  !insertmacro LogDetail "Adding $1 to $0"
  Push $2
  Push $3
  Push $4
