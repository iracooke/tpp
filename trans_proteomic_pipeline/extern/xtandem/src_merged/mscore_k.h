...
public:
    ...
    virtual unsigned long mconvert(double _m, const double _z); // added in cyclone merge
...
protected:
	...
	virtual float ion_check(const unsigned long _v,const size_t _d); // new in cyclone
