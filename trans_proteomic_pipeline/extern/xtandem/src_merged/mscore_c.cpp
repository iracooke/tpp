...
float mscore_c::ion_check(const unsigned long _v,const size_t _s)
{
	// TODO new in cyclone mscore_tandem, so we need similar?
	cerr << "mscore_c::ion_check not yet implemented";
	exit(-1);
}

bool mscore_c::add_A(const unsigned long _t,const long _c)
{
	unsigned long a = 0;
/*
 ...
 */
bool mscore_c::add_B(const unsigned long _t,const long _c)
{
	unsigned long a = 0;
/*
 ...
 * integer converted m/z values
 */
bool mscore_c::add_C(const unsigned long _t,const long _c)
{
	unsigned long a = 0;
/*
 * get the conversion factor between a straight sequence mass and a b-ion
 ...
 * integer converted m/z values
 */
bool mscore_c::add_X(const unsigned long _t,const long _c)
{
 ...
 * integer converted m/z values
 */
bool mscore_c::add_Y(const unsigned long _t,const long _c)
{
	long a = m_lSeqLength - 1;
/*
 ...
 * integer converted m/z values
 */
bool mscore_c::add_Z(const unsigned long _t,const long _c)
{
	long a = m_lSeqLength - 1;
/*
 * get the conversion factor between a straight sequence mass and a y-ion
