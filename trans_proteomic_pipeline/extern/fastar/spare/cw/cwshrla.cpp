...
template <class t_alphabet,const int alphabetsize> CWShiftRLA<t_alphabet,alphabetsize>::CWShiftRLA( const kwset_t& P,
...
template <class t_alphabet,const int alphabetsize> std::ostream& operator<<( std::ostream& os, const CWShiftRLA<t_alphabet,alphabetsize>& r ) {
