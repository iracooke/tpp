...
/* jmt: helper function to make a comma-separated string of the current values */
/* simplified from validations.js */
getSelectValues = function(obj) {
    var output = "";
    for (var i=0; i<obj.options.length; i++ ) {
	output += obj.options[i].value+"";
