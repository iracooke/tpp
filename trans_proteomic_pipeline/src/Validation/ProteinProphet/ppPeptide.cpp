...
// DESCRIPTION:
//
// ppPeptide.cpp: implementation of the ppPeptide class.
...
/*
Peptide::Peptide()                                       // no default constructor for now
{

}
*/

ppPeptide::ppPeptide(    const char * newPeptideName,
                     double newPeptideMass,
                     int newSpectrumQueryIndex,
                     int newHitRank,
                     bool newUnique,
                     double newSpectrumCounts ) :
   m_PeptideName( newPeptideName ),
