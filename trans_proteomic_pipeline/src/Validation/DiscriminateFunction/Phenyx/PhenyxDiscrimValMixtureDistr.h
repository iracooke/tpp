#ifndef PHENYX_DISCRIMV_H
#define PHENYX_DISCRIMV_H
...
class PhenyxDiscrimFunctionFactory;

class PhenyxDiscrimValMixtureDistr : public DiscrimValMixtureDistr {

 public:
  PhenyxDiscrimValMixtureDistr(int charge, const char* engine, const char* name, const char* tag, Boolean maldi, Boolean qtof, Boolean gamma, Boolean nonparam);
  PhenyxDiscrimValMixtureDistr(int charge, const char* engine, const char* name, const char* tag, Boolean maldi, Boolean qtof, Boolean gamma);
  PhenyxDiscrimValMixtureDistr(int charge, const char* engine, const char* name, const char* tag, Boolean maldi, Boolean qtof);
 ...
 public:
  static void registerDiscrimFunctionFactory(PhenyxDiscrimFunctionFactory* factory);
};

#include "Validation/MixtureDistribution/DiscrimFunctionFactory.h"
class PhenyxDiscrimFunctionFactory  : public DiscrimFunctionFactory
{
 public:
  PhenyxDiscrimFunctionFactory(const char* name) : DiscrimFunctionFactory(name)
  {
      PhenyxDiscrimValMixtureDistr::registerDiscrimFunctionFactory(this);
  }

  virtual PhenyxDiscrimFunction* createDiscrimFunction(int charge) = 0;
