#ifndef PHX_DISCR_FUN_H
#define PHX_DISCR_FUN_H
...
class PhenyxDiscrimFunction : public DiscriminantFunction {

 public:
  PhenyxDiscrimFunction(int charge);
