#ifndef OMSSA_DISCRIMV_H
#define OMSSA_DISCRIMV_H
...
class OMSSADiscrimFunctionFactory;

class OMSSADiscrimValMixtureDistr : public DiscrimValMixtureDistr {

 public:
  OMSSADiscrimValMixtureDistr(int charge, const char* engine, const char* name, const char* tag, Boolean maldi, Boolean qtof, Boolean gamma, Boolean nonparam);
  OMSSADiscrimValMixtureDistr(int charge, const char* engine, const char* name, const char* tag, Boolean maldi, Boolean qtof, Boolean gamma);
  OMSSADiscrimValMixtureDistr(int charge, const char* engine, const char* name, const char* tag, Boolean maldi, Boolean qtof);
 ...
 public:
  static void registerDiscrimFunctionFactory(OMSSADiscrimFunctionFactory* factory);
};

#include "Validation/MixtureDistribution/DiscrimFunctionFactory.h"
class OMSSADiscrimFunctionFactory  : public DiscrimFunctionFactory
{
 public:
  OMSSADiscrimFunctionFactory(const char* name) : DiscrimFunctionFactory(name)
  {
      OMSSADiscrimValMixtureDistr::registerDiscrimFunctionFactory(this);
  }

  virtual OMSSADiscrimFunction* createDiscrimFunction(int charge) = 0;
