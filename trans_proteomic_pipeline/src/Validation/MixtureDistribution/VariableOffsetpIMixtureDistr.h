...
class VariableOffsetpIMixtureDistr : public pIMixtureDistr {

 public:

  VariableOffsetpIMixtureDistr(int charge, const char* name, const char* tag, double range, double window, double orig);
