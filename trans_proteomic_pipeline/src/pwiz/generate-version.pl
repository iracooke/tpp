...
# mimics the jam-based version generation for pwiz

# gets the current major and minor revs from Jamroot.jam,
...
$PWIZ_ROOT_PATH=abs_path(dirname($0)."/../../extern/ProteoWizard/pwiz") ;
