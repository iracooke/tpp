...
#ifndef TPP_DIR
#error Please specify the TPP install directory RELATIVE TO THE WEBSERVER ROOT as TPP_WEB in Makefile.config.incl
#endif
...
#error Please specify the TPP install LOCAL directory as TPP_ROOT in Makefile.config.incl 
#endif
#define DEFAULT_CGI_FULL_BIN DEFAULT_TPP_INSTALL_ROOT"cgi-bin/"
#define DEFAULT_LOCAL_BIN DEFAULT_TPP_INSTALL_ROOT"bin/"
#define DEFAULT_LOCAL_PARAMS DEFAULT_TPP_INSTALL_ROOT"params/"
...
#define PEPXML_SCHEMA "pepXML_v117.xsd"
