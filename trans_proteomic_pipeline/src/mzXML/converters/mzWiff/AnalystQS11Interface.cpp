...
using namespace AnalystQS11;

AnalystQS11Interface::AnalystQS11Interface(void) :
	m_pInstrumentInfoLoader(NULL),
	m_pInstrumentInfoParser(NULL)
{
	m_enumLibraryType = LIBRARY_AnalystQS;
	m_InterfaceVersion = "1.1";
}
...
bool AnalystQS11Interface::initInterface(void) {
...
bool AnalystQS11Interface::termInterface(void) {
...
inline void AnalystQS11Interface::initInfoLoader(void) {
	if (NULL!=m_pInstrumentInfoLoader) {
		delete m_pInstrumentInfoLoader;
	}
	m_pInstrumentInfoLoader = new AQS11InstrumentInfoLoader(m_ipFMANWiffFile.GetInterfacePtr(), m_iVerbose);
...
inline void AnalystQS11Interface::termInfoLoader(void) {
	if (NULL!=m_pInstrumentInfoLoader) {
		delete m_pInstrumentInfoLoader;
		m_pInstrumentInfoLoader = NULL;
	}
...
bool AnalystQS11Interface::setInputFile(const std::string& filename) {
	//----------------------------------------
	{
		...
		if (wiffStructure.load(false)) {
			...
			AQS11SoftwareInfoLoader softwareInfoLoader(filename, m_iVerbose);
...
void AnalystQS11Interface::loadSampleList(void) {
...
Scan* AnalystQS11Interface::getScan(void) {
	if (firstTime_) {
		firstTime_ = false;
		return getFirstScan();
	} else {
...
Scan* AnalystQS11Interface::getFirstScan(void)
{
...
Scan* AnalystQS11Interface::getNextScan(void)
{
...
bool AnalystQS11Interface::isValidScan(void) {
...
inline void AnalystQS11Interface::processSpectrum(Scan *pScan) {
...
inline void AnalystQS11Interface::processMSSpectrum(Scan *pScan) {
...
inline void AnalystQS11Interface::processMSSpecData(Scan *pScan) {
...
inline void AnalystQS11Interface::centroidSpecData(bool doDeisotope, double &maxIntensity, bool copy, bool keepCharge) {
...
inline void AnalystQS11Interface::processMRMSpectrum(Scan *pScan) {
...
void AnalystQS11Interface::mergeScans (
...
ScanPtr AnalystQS11Interface::instantiateMergedScans (long lPeriodIndex, const MergedScan &mergedScan) {
...
void AnalystQS11Interface::getSamplePrecursorInfo (long lSampleIndex, long lPeriodIndex) {
...
void AnalystQS11Interface::getSamplePrecursorInfoImpl (long lSampleIndex, long lPeriodIndex) {
...
inline void AnalystQS11Interface::loadMergedScans (long lPeriodIndex) {
...
inline void AnalystQS11Interface::initScanIteratorState () {
...
inline bool AnalystQS11Interface::nextScanIteratorState () {
...
void AnalystQS11Interface::loadInstrumentInfo(long lSampleId) {
...
void AnalystQS11Interface::loadSampleInfo(long lSampleId) {
...
//======================================================================
AQS11InstrumentInfoLoader::AQS11InstrumentInfoLoader(AnalystQS11::IFMANWiffFile *pIFMANWiffFile, int iVerbose)
...
AQS11InstrumentInfoLoader::~AQS11InstrumentInfoLoader(void)
{
}

bool AQS11InstrumentInfoLoader::load(long lSampleId)
{
...
bool AQS11InstrumentInfoLoader::getSampleLog(long lSampleId)
{
...
bool AQS11InstrumentInfoLoader::getMSModel(long lSampleId)
{
	try {
...
AQS11SoftwareInfoLoader::AQS11SoftwareInfoLoader(const std::string &strFilename, int iVerbose)
:	m_strFilename(strFilename),
	m_iVerbose(iVerbose)
{
}

AQS11SoftwareInfoLoader::~AQS11SoftwareInfoLoader(void)
{
}


bool AQS11SoftwareInfoLoader::load(void)
{
	m_strCreator.clear();
