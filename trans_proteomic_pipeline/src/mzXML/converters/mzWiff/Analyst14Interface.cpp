...
using namespace Analyst14;

Analyst14Interface::Analyst14Interface(void) :
	m_pInstrumentInfoLoader(NULL),
	m_pInstrumentInfoParser(NULL)
{
	m_enumLibraryType = LIBRARY_Analyst;
	m_InterfaceVersion = "1.4";
}
...
bool Analyst14Interface::initInterface(void) {
...
bool Analyst14Interface::termInterface(void) {
...
inline void Analyst14Interface::initInfoLoader(void) {
	if (NULL!=m_pInstrumentInfoLoader) {
		delete m_pInstrumentInfoLoader;
	}
	m_pInstrumentInfoLoader = new A14InstrumentInfoLoader(m_ipFMANWiffFile.GetInterfacePtr(), m_iVerbose);
...
inline void Analyst14Interface::termInfoLoader(void) {
	if (NULL!=m_pInstrumentInfoLoader) {
		delete m_pInstrumentInfoLoader;
		m_pInstrumentInfoLoader = NULL;
	}
...
bool Analyst14Interface::setInputFile(const std::string& filename) {
	//----------------------------------------
	{
		...
		if (wiffStructure.load(false)) {
			...
			A14SoftwareInfoLoader softwareInfoLoader(filename, m_iVerbose);
...
void Analyst14Interface::loadSampleList(void) {
...
Scan* Analyst14Interface::getScan(void) {
	if (firstTime_) {
		firstTime_ = false;
		return getFirstScan();
	} else {
...
Scan* Analyst14Interface::getFirstScan(void)
{
...
Scan* Analyst14Interface::getNextScan(void)
{
...
bool Analyst14Interface::isValidScan(void) {
...
inline void Analyst14Interface::processSpectrum(Scan *pScan) {
...
inline void Analyst14Interface::processMSSpectrum(Scan *pScan) {
...
inline void Analyst14Interface::processMSSpecData(Scan *pScan) {
...
inline void Analyst14Interface::centroidSpecData(bool doDeisotope, double &maxIntensity, bool copy, bool keepCharge) {
...
inline void Analyst14Interface::processMRMSpectrum(Scan *pScan) {
...
void Analyst14Interface::mergeScans (
...
ScanPtr Analyst14Interface::instantiateMergedScans (long lPeriodIndex, const MergedScan &mergedScan) {
...
void Analyst14Interface::getSamplePrecursorInfo (long lSampleIndex, long lPeriodIndex) {
...
void Analyst14Interface::getSamplePrecursorInfoImpl (long lSampleIndex, long lPeriodIndex) {
...
inline void Analyst14Interface::loadMergedScans (long lPeriodIndex) {
...
inline void Analyst14Interface::initScanIteratorState () {
...
inline bool Analyst14Interface::nextScanIteratorState () {
...
void Analyst14Interface::loadInstrumentInfo(long lSampleId) {
...
void Analyst14Interface::loadSampleInfo(long lSampleId) {
...
//======================================================================
A14InstrumentInfoLoader::A14InstrumentInfoLoader(Analyst14::IFMANWiffFile *pIFMANWiffFile, int iVerbose)
...
A14InstrumentInfoLoader::~A14InstrumentInfoLoader(void)
{
}

bool A14InstrumentInfoLoader::load(long lSampleId)
{
...
bool A14InstrumentInfoLoader::getSampleLog(long lSampleId)
{
...
bool A14InstrumentInfoLoader::getMSModel(long lSampleId)
{
	try {
...
A14SoftwareInfoLoader::A14SoftwareInfoLoader(const std::string &strFilename, int iVerbose)
:	m_strFilename(strFilename),
	m_iVerbose(iVerbose)
{
}

A14SoftwareInfoLoader::~A14SoftwareInfoLoader(void)
{
}


bool A14SoftwareInfoLoader::load(void)
{
	m_strCreator.clear();
