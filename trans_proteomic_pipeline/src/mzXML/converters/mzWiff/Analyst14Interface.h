...
#include "wiff14lib/analyst14tlbs.h"
#include "AnalystBaseInterface.h"

class A14InstrumentInfoLoader
{
public:
	A14InstrumentInfoLoader(Analyst14::IFMANWiffFile *pIFMANWiffFile, int iVerbose);
	~A14InstrumentInfoLoader(void);
public:
...
private:
	Analyst14::IFMANWiffFile *m_pIFMANWiffFile;
	int m_iVerbose;
};

class A14SoftwareInfoLoader
{
public:
	A14SoftwareInfoLoader(const std::string &strFilename, int iVerbose);
	~A14SoftwareInfoLoader(void);
public:
...
class Analyst14Interface : public AnalystBaseInterface {
private:
	_bstr_t     m_bstrWiffFileName;

	Analyst14::IFMANChromDataPtr     m_ipFMANChromData;
	Analyst14::IFMANSpecDataPtr      m_ipFMANSpecData;
	Analyst14::IFMANWiffFilePtr      m_ipFMANWiffFile;
	Analyst14::IPeakFinderFactoryPtr m_ipPeakFinderFactory;
	Analyst14::IPeakFinder2Ptr       m_ipPeakFinder;
	BSTR                           m_paramsString;
	Analyst14::IFMANSpecDataPtr      m_ipFMANSpecDataToMerge;
	Analyst14::IFMANSpecDataPtr      m_ipFMANSpecDataCopy;
...
private:
	A14InstrumentInfoLoader *m_pInstrumentInfoLoader;
	InstrumentInfoParser  *m_pInstrumentInfoParser;

public:
	Analyst14Interface(void);
	virtual ~Analyst14Interface(void);
