...
inclusion of "analyst14tlbs.h" with the preprocessor _IMPORT_PROCESSING_ 
...
Directory:
trans_proteomic_pipeline\src\mzXML\converters\mzWiff\libs\analyst-1.4\ReadMe.txt

This directory contains the Analyst 1.4 DLLs to be used by #import directive
