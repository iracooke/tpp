...
inclusion of "analystqs20tlbs.h" with the preprocessor _IMPORT_PROCESSING_ 
...
Directory:
trans_proteomic_pipeline\src\mzXML\converters\mzWiff\libs\analystqs-2.0\ReadMe.txt

This directory contains the AnalystQS 2.0 DLLs to be used by #import directive
