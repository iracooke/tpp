...
using namespace Analyst15;

Analyst15Interface::Analyst15Interface(void) :
	m_pInstrumentInfoLoader(NULL),
	m_pInstrumentInfoParser(NULL)
{
	m_enumLibraryType = LIBRARY_Analyst;
	m_InterfaceVersion = "1.5";
}
...
bool Analyst15Interface::initInterface(void) {
...
bool Analyst15Interface::termInterface(void) {
...
inline void Analyst15Interface::initInfoLoader(void) {
	if (NULL!=m_pInstrumentInfoLoader) {
		delete m_pInstrumentInfoLoader;
	}
	m_pInstrumentInfoLoader = new A15InstrumentInfoLoader(m_ipFMANWiffFile.GetInterfacePtr(), m_iVerbose);
...
inline void Analyst15Interface::termInfoLoader(void) {
	if (NULL!=m_pInstrumentInfoLoader) {
		delete m_pInstrumentInfoLoader;
		m_pInstrumentInfoLoader = NULL;
	}
...
bool Analyst15Interface::setInputFile(const std::string& filename) {
	//----------------------------------------
	{
		...
		if (wiffStructure.load(false)) {
			...
			A15SoftwareInfoLoader softwareInfoLoader(filename, m_iVerbose);
...
void Analyst15Interface::loadSampleList(void) {
...
Scan* Analyst15Interface::getScan(void) {
	if (firstTime_) {
		firstTime_ = false;
		return getFirstScan();
	} else {
...
Scan* Analyst15Interface::getFirstScan(void)
{
...
Scan* Analyst15Interface::getNextScan(void)
{
...
bool Analyst15Interface::isValidScan(void) {
...
inline void Analyst15Interface::processSpectrum(Scan *pScan) {
...
inline void Analyst15Interface::processMSSpectrum(Scan *pScan) {
...
inline void Analyst15Interface::processMSSpecData(Scan *pScan) {
...
inline void Analyst15Interface::centroidSpecData(bool doDeisotope, double &maxIntensity, bool copy, bool keepCharge) {
...
inline void Analyst15Interface::processMRMSpectrum(Scan *pScan) {
...
void Analyst15Interface::mergeScans (
...
ScanPtr Analyst15Interface::instantiateMergedScans (long lPeriodIndex, const MergedScan &mergedScan) {
...
void Analyst15Interface::getSamplePrecursorInfo (long lSampleIndex, long lPeriodIndex) {
...
void Analyst15Interface::getSamplePrecursorInfoImpl (long lSampleIndex, long lPeriodIndex) {
...
inline void Analyst15Interface::loadMergedScans (long lPeriodIndex) {
...
inline void Analyst15Interface::initScanIteratorState () {
...
inline bool Analyst15Interface::nextScanIteratorState () {
...
void Analyst15Interface::loadInstrumentInfo(long lSampleId) {
...
void Analyst15Interface::loadSampleInfo(long lSampleId) {
...
//======================================================================
A15InstrumentInfoLoader::A15InstrumentInfoLoader(Analyst15::IFMANWiffFile *pIFMANWiffFile, int iVerbose)
...
A15InstrumentInfoLoader::~A15InstrumentInfoLoader(void)
{
}

bool A15InstrumentInfoLoader::load(long lSampleId)
{
...
bool A15InstrumentInfoLoader::getSampleLog(long lSampleId)
{
...
bool A15InstrumentInfoLoader::getMSModel(long lSampleId)
{
	try {
...
A15SoftwareInfoLoader::A15SoftwareInfoLoader(const std::string &strFilename, int iVerbose)
:	m_strFilename(strFilename),
	m_iVerbose(iVerbose)
{
}

A15SoftwareInfoLoader::~A15SoftwareInfoLoader(void)
{
}


bool A15SoftwareInfoLoader::load(void)
{
	m_strCreator.clear();
