...
##
##  $Log$
##  Revision 1.1  2004/12/15 01:59:06  ppatrick
##  Initial revision
##
##  Revision 1.2  2004/08/30 19:11:15  brendanx
##  Fix line endings.
##
##  Revision 1.1.1.1  2004/03/28 21:47:05  ppatrick
##  Initial import.
##
##
##
...
void iCSHA1::Transform(unsigned long state[5], unsigned char buffer[64])
{
...
void iCSHA1::Update(unsigned char* data, unsigned int len)
{
...
bool iCSHA1::HashFile(char *szFileName)
{
...
void iCSHA1::ReportHash(char *szReport, unsigned char uReportType)
{
	unsigned char i = 0;
	char szTemp[4];
...
void iCSHA1::GetHash(unsigned char *uDest)
{
