...
##
##  $Log$
##  Revision 1.2  2005/03/10 19:02:08  tholzman
##  *** empty log message ***
##
...
{
	off_t ulFileSize = 0, ulRest = 0, ulBlocks = 0;
	unsigned long i = 0;
	...
	fseeko(fIn,(off_t) 0L, SEEK_END);
	ulFileSize = ftello(fIn);
	fseeko(fIn,(off_t) 0L, SEEK_SET);
